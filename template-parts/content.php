...
?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('flex flex-row bg-white p-6 rounded-2xl mb-9'); ?>>
        ...
        <div class="w-4/6 pl-5">
            ...
            <h2 class="mb-3 line-clamp-3 text-4xl font-bold leading-10"> <?php the_title() ?></h2>
            ...
            <div class="mt-5 flex items-center">
                <svg class="h-5 w-5 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
